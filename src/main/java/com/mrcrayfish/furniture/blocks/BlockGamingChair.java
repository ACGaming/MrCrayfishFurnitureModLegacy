...
import com.mrcrayfish.furniture.util.CustomSeatUtil;
 ...
 * Author: MrCrayfish
 */
public class BlockGamingChair extends BlockDevice.Colored
{
    ...
    public BlockGamingChair()
    {
        super(Material.ROCK);
        this.setRegistryName("gaming_chair");
    ...
    {
        if(Minecraft.getMinecraft().player != null && Minecraft.getMinecraft().player.getRidingEntity() instanceof EntityCustomSeat)
        {
            return EMPTY_BOX;
        }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        if(!worldIn.isRemote)
        {
            CustomSeatUtil.createSeatAndSit(worldIn, pos, playerIn, 0.5);
        }
        return true;
    }
    ...
    {
        return new TileEntityGamingChair();
    }
